 ...
 */
package com.la_a.dashscanner.fragment;
...
import com.la_a.dashscanner.BarcodeGraphic;
import com.la_a.dashscanner.BarcodeGraphicTracker;
import com.la_a.dashscanner.BarcodeTrackerFactory;
import com.la_a.dashscanner.R;

import com.la_a.dashscanner.activity.MainActivity;
import com.la_a.dashscanner.camera.CameraSource;
import com.la_a.dashscanner.camera.CameraSourcePreview;
import com.la_a.dashscanner.camera.GraphicOverlay;
 ...
 */
public class FragmentCaptureBarcode extends Fragment implements BarcodeGraphicTracker.BarcodeDetectorListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = inflater.inflate(R.layout.barcode_capture, container, false);
        mPreview = (CameraSourcePreview) root.findViewById(R.id.preview);
        mGraphicOverlay = (GraphicOverlay<BarcodeGraphic>) root.findViewById(R.id.graphicOverlay);

        // read parameters from the intent used to launch the activity.
//        boolean autoFocus = getIntent().getBooleanExtra(AutoFocus, false);
//        boolean useFlash = getIntent().getBooleanExtra(UseFlash, false);
//        autoCapture = getActivity().getIntent().getBooleanExtra(AutoCapture, false);
        autoCapture = true;
...
//                .show();
    ...
    public void setAutoCapture(boolean p_enabled)
    {
        autoCapture = p_enabled;
    }
...
//            boolean useFlash = getIntent().getBooleanExtra(UseFlash, false);
        ...
        DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                //getActivity().getFragmentManager().beginTransaction().remove(FragmentCaptureBarcode.this).commit();
            }
        };
    ...
    public void onObjectDetected(Barcode data) {
        ...
        {
            ((MainActivity) getActivity()).onObjectDetected(data);
        }
        else
        {
            Intent mIntent = new Intent();
            mIntent.putExtra(BarcodeObject, data);
            getActivity().setResult(CommonStatusCodes.SUCCESS, mIntent);
            //finish();
        }
    }
